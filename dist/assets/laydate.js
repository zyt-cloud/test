...
;!function(a) {
    ...
    c.events = function() {
        ...
        a.$("#laydate_table").on("click", "td", function(a){
        ...
        e.hmson = function(a, d) {
            ...
            c.each(e, function(b, e) {
                f ? c.addClass(e, h[1]) : c.timeVoid(b, d) ? c.addClass(e, h[1]) : window.$("#laydate_hmsno").off("click.span").on("click.span","span",function(){
        ...
        ,
        window.$("#laydate_hms").on("click","input",function(b){
